...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`mako by seris`}</title>

        <meta
          name="description"
          content="Experience mako by seris - Your Comprehensive E-commerce Solution with Seamless Payment Capabilities and Unmatched Features for a Revolutionary Shopping Experience"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1592503254549-d83d24a4dfab?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlLWNvbW1lcmNlfGVufDB8fHx8MTY5OTY3NzIzNXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience mako by seris - Your Comprehensive E-commerce Solution with Seamless Payment Capabilities and Unmatched Features for a Revolutionary Shopping Experience`}
            </Text>
            <Box
